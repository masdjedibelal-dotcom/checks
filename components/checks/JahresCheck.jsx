  ...
  if(phase===2){
    ...
    return(
      <div style={{...T.page,"--accent":C}} key={ak} className="fade-in">
        ...
        <div style={T.hero}><div style={T.eyebrow}>Schritt 2 von 3 · Lebenssituation</div><div style={T.h1}>Was bewegt Sie gerade?</div><div style={T.body}>Alles Zutreffende antippen — der Check passt sich Ihrer Situation an.</div></div>
